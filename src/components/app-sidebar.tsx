    ...
    <div className="flex h-full flex-col border-r bg-card">
        <div className="flex h-16 shrink-0 items-center border-b px-6">
            <Link href="/" className="flex items-center gap-3 font-headline">
                ...
                <span className="text-lg">RailTracer</span>
            </Link>
        </div>
                        ...
                        return (
                            <li key={href}>
                                <Link
                                    href={href}
                                    className={cn(
                                        'flex items-center gap-3 rounded-lg px-3 py-3 text-muted-foreground transition-all hover:text-primary hover:bg-secondary',
